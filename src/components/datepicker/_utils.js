...
module.exports={
        getVisibleSeconds: function(m, step) {
            var year = m.year(),
                month = m.month(),
                day = m.date(),
                hour = m.hours(),
            ...
            for (second = 0; second < 60; second += step) {
                pushedDate = createNewDate(year, month, day, hour - offset, minute, second);
                seconds.push(pushedDate);
            }
            return seconds;
        },
        ...
        toUnixTimestamp: function(string) {
            ...
            if (tz) {
                ...
                if (moment.isMoment(m)) {
                    ...
                    if (typeof m === 'object') {
                        ...
                        var date = moment.unix(m.toString().substr(0, 10));
                        if(isNaN(date._i)) {
                            date = moment(new Date(m));
                        }
                        return date;
                    }
                }
